 ...
 * 
 */
class Postfix_Calc_Tree : public Calc_Node_Vistior {
public:

    /**
     * @brief Construct a new Postfix_Calc_Tree object
     * 
     */
    Postfix_Calc_Tree (void);

    /**
     * @brief Destroy the Postfix_Calc_Tree object
     * 
     */
    virtual ~Postfix_Calc_Tree (void);
